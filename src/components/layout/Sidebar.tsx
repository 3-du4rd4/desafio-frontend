...
const Sidebar = ({ isOpen, setIsOpen }: SidebarProps) => {
  ...
  return (
    <div className={`fixed lg:static top-0 left-0 z-50 w-3/4 lg:w-72 h-screen bg-[#4D44B5] shadow-md 
                      p-6 !pr-0 flex flex-col transform transition-transform duration-300
